...
Original file is located at
    https://colab.research.google.com/drive/17HrlaXXdhT5jf4JjBVBXLJjU-l2RL1tJ

# Ultimate Accompaniment Transformer (ver. 1.0)
...
melody_MIDI_patch_number = 40 # @param {type:"slider", min:0, max:127, step:1}
accompaniment_MIDI_patch_number = 0 # @param {type:"slider", min:0, max:127, step:1}
number_of_prime_melody_notes = 0 # @param {type:"slider", min:0, max:64, step:1}
max_number_of_tokens_per_melody_note = 32 # @param {type:"slider", min:4, max:64, step:1}
force_accompaniment_generation_for_each_melody_note = True # @param {type:"boolean"}
...
for m in tqdm.tqdm(melody_chords[number_of_prime_melody_notes:]):
  ...
  try:
    ...
    output1.extend(m)
    out = generate_acc(output1,
                       force_acc=force_accompaniment_generation_for_each_melody_note,
                       num_toks_per_note=max_number_of_tokens_per_melody_note,
